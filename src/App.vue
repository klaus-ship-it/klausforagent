...
// 代理後台對外統一稱為「代理」；保留舊層級字面值僅供示範資料與相容既有判斷使用。
...
const agentRows = ref<AgentRow[]>([
  { id: 'A-1001', uid: 'AG-10001', account: 'agent_taipei', displayName: '台北代理', referralCode: 'PLY-TW-8F4K', phone: '0912345678', email: 'taipei@example.com', contactMethod: 'Line: @agent_taipei', twoFactor: '已啟用', twoFactorBoundAt: '2026-07-18 14:22:08', twoFactorRequired: true, level: '總代理', path: 'agent_taipei', currency: 'TWD', point: 6, children: 3, directAgentCount: 2, directPlayerCount: 2, totalAgentCount: 4, totalPlayerCount: 186, totalDeposit: 342800, totalEffectiveBet: 1284600, walletBalance: 28460, withdrawalEnabled: true, registerAt: '2026-07-18 14:22:08', registerIp: '10.20.8.15', lastLoginAt: '2026-09-02 11:00:00', lastLoginIp: '10.20.8.15', status: '啟用', planId: 'PLAN-001', model: '有效投注額', cycle: '每週' },
  { id: 'A-1006', uid: 'AG-10121', account: 'agent_pnl', displayName: '輸贏代理', referralCode: 'PLY-TWD-PNL3', phone: '0922333444', email: 'pnl@example.com', contactMethod: 'Line: @agent_pnl', twoFactor: '未啟用', twoFactorBoundAt: '尚未綁定', twoFactorRequired: true, level: '總代理', path: 'agent_pnl', currency: 'TWD', point: 5, children: 6, walletBalance: 9740, withdrawalEnabled: true, registerAt: '2026-07-21 09:12:44', registerIp: '10.20.8.66', lastLoginAt: '2026-09-01 17:42:10', lastLoginIp: '10.20.8.66', status: '啟用', planId: 'PLAN-003', model: '輸贏', cycle: '每月' },
...
function createAgent() {
  ...
  const parentDepth = identityAgentPath.value.split(' > ').length
  const level = currentRole.value === '運營商' ? '總代理' : `${['', '一級代理', '二級代理', '三級代理', '四級代理'][Math.min(parentDepth, 4)]}`
